...
if (!isset($_SESSION['user_logged_in_student_id'])) {
    $_SESSION['login_error_user'] = "Anda harus login untuk melihat hasil penerimaan.";
...
$page_title = "Hasil Penerimaan Siswa";
...
if ($student_data && isset($student_data['birth_date'])) {
    try {
        $date_obj = new DateTime($student_data['birth_date']);
        ...
        $day_display = $date_obj->format('d');
        $month_num_display = $date_obj->format('m');
        $year_display = $date_obj->format('Y');
        
        $month_name_display = isset($bulan_map_display[$month_num_display]) ? $bulan_map_display[$month_num_display] : $month_num_display;
        
        $birth_date_display = $day_display . ' ' . $month_name_display . ' ' . $year_display;
...
<head>
    ...
    <style>
        ...
        .result-container.success { border-top-color: #28a745; }
        .result-container.warning { border-top-color: #ffc107; }
        .result-container.danger { border-top-color: #dc3545; }
        .result-container.info { border-top-color: #17a2b8; }
        ...
        .result-container.warning h1 { color: #b8860b; }
        ...
        .message-display.warning { background-color: #ffc107; color: #333; }
...
<body>
    <div class="result-container <?php echo htmlspecialchars($message_class); ?>">
        ...
        <div class="student-info">
            ...
            <?php if ($application_data && isset($application_data['chosen_major_code'])): ?>
