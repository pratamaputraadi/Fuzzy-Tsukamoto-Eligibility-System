...
if (isset($_GET['student_id']) && is_numeric($_GET['student_id'])) {
    ...
    try {
        ...
        // Ambil nilai yang sudah ada jika ada (untuk pre-fill form)
        ...
        // Ambil data fisik yang sudah ada jika ada
...
// Daftar mata pelajaran (sesuai kebutuhan logika fuzzy Anda)
$subjects = [
