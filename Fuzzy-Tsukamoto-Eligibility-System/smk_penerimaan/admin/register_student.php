...
<head>
    ...
    <link rel="stylesheet" href="../css/admin_style.css"> <style>
        /* Anda bisa tambahkan CSS spesifik halaman ini di sini atau di admin_style.css */
        body {
        ...
        .page-header { /* Mirip dashboard-header */
        ...
        .form-container {
            ...
            margin: 30px auto; /* Tengahkan form */
        }
        .form-container h2 {
            text-align: center;
            margin-bottom: 25px;
        ...
        .form-container textarea { /* Jika ada textarea */
            width: 100%;
            padding: 12px 15px;
            margin-bottom: 20px;
        ...
        .form-container button {
            width: 100%;
            padding: 12px 15px;
            background-color: #28a745; /* Warna hijau untuk "Buat Akun" */
            color: white;
            border: none;
            border-radius: 6px;
            cursor: pointer;
